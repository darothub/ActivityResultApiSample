package com.darothub.activityresultapi
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getTmpFileUri(): Uri {
        ...
        val applicationId = baseContext.packageName


        return FileProvider.getUriForFile(applicationContext, "$applicationId.provider", tmpFile)
    }
}